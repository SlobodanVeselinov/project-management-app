<template>
    ...
    >
        ...
        >
            ...
            <div class="mb-3">
                <div class="w-full">
                    <h1 class="text-sm text-red-500">Are you sure you want to delete {{  developer.name.toUpperCase()  }} from the database? This can`t be undone!</h1>
                </div>
            ...
            <div class="border-t pt-5 mt-5">
                <button
                    class="border rounded border-red-500 text-sm text-red-500 mr-2 px-3 py-2 hover:bg-red-500 hover:text-white transition duration-150 ease-in-out"
                    @click="deleteUser"
                >
                    Yes, delete it!
                </button>
...
export default {
    ...
    methods: {
        ...
        deleteUser(){
            this.removeUser(this.developer)
            this.$emit("closeConfirmationModal");
        }
